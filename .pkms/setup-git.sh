#!/bin/bash
# PKMS Git Configuration Setup
# Run this to configure git hooks, aliases, and settings for PKMS
...
echo "🔧 Setting up PKMS Git configuration..."
echo ""
...
echo ""
echo "✅ PKMS Git configuration complete!"
echo ""
...
echo ""
echo "Hooks enabled:"
echo "  pre-commit  - Validate JSON/TOML, check for secrets"
